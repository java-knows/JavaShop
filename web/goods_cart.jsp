	...
	<div class="cart-items">
		<div class="container">
				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						...
						<div class="cart-item-info">
							...
							<a class="btn btn-info" href="javascript:lessen(${item.key});">减少</a>
							<a class="btn btn-info" href="javascript:deletes(${item.key});">删除</a>
						</div>
			...
			<div class="cart-header col-md-12">
				...
				<a class="btn btn-success btn-lg" style="margin-left:74%" href="/order_submit">去结算</a>
			</div>
